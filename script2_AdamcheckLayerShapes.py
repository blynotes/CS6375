...
def runAlgorithm(param, outputText=""):
    ...
    with open('OutputRunsScript2CheckLayerShapes.xls', 'a', newline='') as outfile:
...
def main():
    ...
    bestKeep_prob3 = 0.6  # Dropouts don't matter for this test
    ...
    for layer in numLayerRange:
        for x1 in layerSizeRange:
            ...
            for x2 in layerSizeRange:
                tmpLayer2 = x2
                if layer == 2:
                    multipleRuns.append({'learning_rate': bestLearnRate, 'beta1': bestBeta1, 'beta2': bestBeta2, 'epsilon': bestEpsilon, 'batch_size': bestBatchSize,
                                         'layers': [
